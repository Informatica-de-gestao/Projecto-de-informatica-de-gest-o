    ...
    <div class="page-wrapper">
        <div class="content">
          ...
          <td>'.$row['Titulo'].'</td>
            ...
            <td><a href="apagarUtilizador.php?ID_='.$row['ID_oferta'].'"  class="  fa fa-trash-o red_color"> Eliminar</a></td>
            <td><a href="form_edit_receita.php?id='.$row['ID_oferta'].'" class="fa fa-wrench green_color"> Editar</a></td>
